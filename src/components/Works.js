...
export default function Works({ closeCheckout }) {
  return (
    <WorksFrame>
      ...
      <Desc>
        $DURAG tokens are listed starting at $12 USD. Each buy/sell will move the price. The increase or decrease
        follows a{' '}
        <a
        ...
        . $DURAG will eventually find an equillibrium based on market demand.
      </Desc>
